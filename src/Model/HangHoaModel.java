 ...
 * @author nghia
 */
//tao va dua du lieu len bang
public class HangHoaModel extends AbstractTableModel{
    private Vector tbData;
    private Vector colName;
    private String col[] = {"ID", "Tên", "Loại","Số lượng", "ĐVT","Giá nhập","Giá xuất"};
    public HangHoaModel(ResultSet rs)
    {
        try
        {
